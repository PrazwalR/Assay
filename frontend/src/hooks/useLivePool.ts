 ...
 * random walk -- a demonstration of the mechanism rather than a reading of it. Now the pool's
 * whole trading history is on chain, and `signedMispricing` returns the same signed
